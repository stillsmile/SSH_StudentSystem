...
<article class="page-container">
	<form action="scinfoupdate.action" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="" name="deptName" id="deptName">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="" name="teacherName" id="teacherName">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>学分：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="" name="credits" id="credits">
			</div>
		</div>
		<div class="row cl">
...
// 	});
		...
		$("#deptName").val(parent.aData.deptName);
		$("#courseName").val(parent.aData.courseName);
		$("#teacherName").val(parent.aData.teacherName);
		$("#credits").val(parent.aData.credits);
