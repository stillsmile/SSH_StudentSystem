...
<article class="page-container">
	<form action="scoreinfoupdate.action" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="" name="score" id="score">
			</div>
		</div>
		<div class="row cl">
