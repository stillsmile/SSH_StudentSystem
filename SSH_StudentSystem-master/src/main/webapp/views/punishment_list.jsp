...
<body>
	<nav class="breadcrumb">
		...
		处罚管理 <span class="c-gray en">&gt;</span> 处罚列表 <a
	...
	<div class="page-container">
		<div class="text-c">
			处罚搜索： <input type="text" class="input-text" style="width: 250px"
				placeholder="输入关键字" id="" name="">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				...
				onclick="member_add('添加处罚','punishment_add.jsp','','510')"
				class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i>
					添加处罚</a></span> <span class="r">共有数据：<strong id="recordsTotal"></strong> 条
			</span>
		</div>
		<div class="mt-20">
			<table
...
$(function(){
	$('#students_table').DataTable({
        ...
        "sAjaxSource": "punishmentinfo.action",
        "aoColumnDefs":[
        	{"sClass": "text-c","aTargets":[0,1,2,3,4,5,6,7]},
        ...
        "aoColumns": [
            ...
            { "mData": "className"},
            { "mData": "deptName"},
            { "mData": "punishmentContent"},
            { "mData": "data"},
            {"sDefaultContent": "<a title='编辑' href='javascript:;' onclick='member_edit(\"编辑\",\"punishment_edit.jsp\",this,\"\",\"510\")' class='ml-5 edit' style='text-decoration:none'><i class='Hui-iconfont'>&#xe6df;</i></a><a title='删除' href='javascript:;' onclick='member_del(this)' class='ml-5' style='text-decoration:none'><i class='Hui-iconfont'>&#xe6e2;</i></a>"}
        ],
