...
<body>
	...
	<div class="page-container">
		<div class="text-c">
			活动搜索： <input type="text" class="input-text" style="width: 250px"
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				...
				onclick="member_add('添加活动','activity_add.jsp','','510')"
				class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i>
					添加活动</a></span> <span class="r">共有数据：<strong id="recordsTotal"></strong> 条
			</span>
		</div>
		<div class="mt-20">
			<table
...
$(function(){
	$('#students_table').DataTable({
        ...
        "sAjaxSource": "activityinfo.action",
        "aoColumnDefs":[
        ...
        "aoColumns": [
            ...
            { "mData": "className"},
            { "mData": "deptName"},
            { "mData": "activityContent"},
            { "mData": "data"},
            {"sDefaultContent": "<a title='编辑' href='javascript:;' onclick='member_edit(\"编辑\",\"activity_edit.jsp\",this,\"\",\"510\")' class='ml-5 edit' style='text-decoration:none'><i class='Hui-iconfont'>&#xe6df;</i></a><a title='删除' href='javascript:;' onclick='member_del(this)' class='ml-5' style='text-decoration:none'><i class='Hui-iconfont'>&#xe6e2;</i></a>"}
        ],
