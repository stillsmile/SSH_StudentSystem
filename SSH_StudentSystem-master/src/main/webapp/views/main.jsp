...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs">学生管理系统</a> 
		<a class="logo navbar-logo-m f-l mr-10 visible-xs">学生管理系统</a> 
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="views/student_list.jsp" data-title="学生列表" href="javascript:;">学生列表</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="views/selectcourse_list.jsp" data-title="选课列表" href="javascript:void(0)">选课列表</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a data-href="views/score_list.jsp" data-title="成绩管理" href="javascript:void(0)">成绩列表</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a data-href="views/activity_list.jsp" data-title="品牌管理" href="javascript:void(0)">活动列表</a></li>
		...
		<dl id="menu-product">
			<dt><i class="Hui-iconfont">&#xe64b;</i> 奖励管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="views/reward_list.jsp" data-title="奖励列表" href="javascript:void(0)">奖励列表</a></li>
					
			</ul>
		</dd>
	</dl>
		<dl id="menu-product">
			<dt><i class="Hui-iconfont">&#xe64b;</i> 处罚管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="views/punishment_list.jsp" data-title="品牌管理" href="javascript:void(0)">处罚列表</a></li>
					<li><a data-href="product-category.html" data-title="分类管理" href="javascript:void(0)">分类管理</a></li>
					<li><a data-href="product-list.html" data-title="产品管理" href="javascript:void(0)">产品管理</a></li>
			</ul>
		</dd>
...
<script type="text/javascript" src="${APP_PATH}/static/layer/2.4/layer.js"></script>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${APP_PATH}/static/js/jquery.contextmenu.r2.js"></script>
