...
<article class="page-container">
	<form action="punishmentinfoupdate.action" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>处罚内容：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="" name="punishmentContent" id="punishmentContent">
			</div>
		</div>
		<div class="row cl">
...
$(function(){
		...
		$("#punishmentContent").val(parent.aData.punishmentContent);
		$("#data").val(parent.aData.data);
